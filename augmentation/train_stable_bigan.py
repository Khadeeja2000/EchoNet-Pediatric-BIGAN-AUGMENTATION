...
def train(cfg: dict) -> None:
    ...
    for epoch in range(cfg["epochs"]):
        ...
        torch.save(G.state_dict(), f"checkpoints/stable_G_epoch{epoch}.pt")
        torch.save(E.state_dict(), f"checkpoints/stable_E_epoch{epoch}.pt")
        torch.save(D.state_dict(), f"checkpoints/stable_D_epoch{epoch}.pt")
